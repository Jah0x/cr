      ...
      <div className="grid tenant-settings-grid">
            ...
            <div className="form-stack">
              {data.modules.map((module) => (
                <Checkbox
                  ...
                  label={`${module.name} (${module.code})${!module.is_active ? ` — ${t('settings.inactive')}` : ''}`}
                />
              ))}
            </div>
          </Card>
        ...
        <div className="tenant-settings-grid__right">
          {uiPrefsFeatureEnabled && (
            <Card title={t('settings.uiPreferences')}>
              <div className="form-stack">
                {[
        ...
        <Card
          title={t('settings.taxesTitle')}
          subtitle={t('settings.taxesSubtitle')}
          className="tenant-settings-grid__taxes"
        >
          <div className="form-stack">
            <Checkbox
              ...
              label={t('settings.taxesEnabled')}
            />
            <div className="form-row">
              <Select
                label={t('settings.taxesMode')}
                value={taxDraft.mode}
                disabled={updateTenantSettings.isPending}
              ...
              <Select
                label={t('settings.taxesRounding')}
                      ...
                      <tr key={rule.id}>
                          ...
                          <div className="form-inline">
                            {paymentMethods.map((method) => (
                              <Checkbox
                                ...
                                label={t(`settings.taxRuleMethod.${method}`)}
                              />
                            ))}
                          </div>
                        </td>
                        <td>
                          <Checkbox
                            ...
                            label={rule.is_active ? t('settings.taxRuleActive') : t('settings.taxRuleInactive')}
                          />
                        </td>
                        <td>
                          <SecondaryButton type="button" onClick={() => handleTaxRuleDelete(rule.id)}>
                            {t('common.delete')}
                          </SecondaryButton>
                        </td>
                      </tr>
            ...
            <div className="form-row">
              ...
              />
              <PrimaryButton type="button" onClick={addTaxRule} disabled={updateTenantSettings.isPending}>
